...
if [[ $VAR_Username =~ $regex ]]&&[[ $VAR_Event == "Yes" ]]; then echo "Verification Successful! Please continue..."; sh /home/developer/src/dne-appsec/.bash/submit.sh 2 $VAR_Username $DEVENV_APP_8080_URL $DEVENV_INSTANCE_ID $DEVENV_USER; else echo "Please provide a valid email address"; fi
